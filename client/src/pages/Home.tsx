...
import { updateMetaTags, addStructuredData, organizationSchema, localBusinessSchema, pageConfigs } from "@/lib/seo";
  ...
  const highlights = [
    {
      ...
      description:
        "We don't just check boxes. We look for people who show up, who care about their clients, and who are in this for the right reasons.",
    },
    {
      icon: Heart,
      title: "Your Work Goes Further",
      description:
        "Every hour you work helps families here in Washington AND supports kids and women in Ghana. That's not just a job—that's impact.",
    },
    {
      icon: Zap,
      title: "It Actually Works",
      description:
        "CNA staffing is a proven model. Good margins, steady work, and we're built lean so we can actually pay you well and keep things running.",
    },
    {
      icon: Users,
      title: "Real Relationships",
      description:
        "We're not some big corporate machine. You'll talk to us directly. We listen. We solve problems. We treat people like people.",
    },
  ];
  ...
  const caregiverBenefits = [
    {
      ...
      description:
        "You're not just filling shifts. You're giving families peace of mind and helping vulnerable people get the care they deserve.",
    },
    {
      title: "Steady Paychecks",
      description:
        "Predictable hours, reliable pay, no guessing games. We believe you should know what you're making and when.",
    },
    {
      title: "You're Part of a Team",
      description:
        "Not a number. We know your name, your story, and we actually care about your wellbeing.",
    },
    {
      title: "Global Impact",
      description:
        "Know that your work is helping kids and families in Ghana. Every hour you work creates opportunity somewhere else.",
    },
  ];
  ...
  const familyBenefits = [
    {
      ...
      description:
        "We don't just hire anyone. We find people who actually care and show up when they say they will.",
    },
    {
      title: "The Right Match",
      description:
        "We listen to what you need and match you with someone who gets it. Not just whoever's available.",
    },
    {
      title: "Peace of Mind",
      description:
        "You can talk to us directly. No runaround. Just real people helping you get the care your loved one deserves.",
    },
    {
      title: "Values That Align",
      description:
        "You're working with a company that treats caregivers right and puts money back into communities that need it.",
    },
  ];
  ...
  const goToMarketChannels = [
    {
      ...
      description:
        "Getting licensed so we can work directly with the state to serve families who need support",
    },
    {
      channel: "Adult Family Homes",
      description:
        "These facilities are desperate for reliable CNAs. We know the people running them and can help fast.",
    },
    {
      channel: "Community",
      description:
        "Churches, senior centers, immigrant communities—places where families actually look for help",
    },
    {
      channel: "Online",
      description:
        "Google, Facebook, a clean website. Making it easy for people to find us and understand what we do.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-16 md:py-28 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663607234030/SUYffTLqfYfkiJeh93ob3u/hero-forevergreen-bcCuaGV2erRu3iLJhXiEoy.webp')",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                That's the size of the home care market. It's huge.
              </p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-primary mb-2">33%</p>
              <p className="text-sm text-muted-foreground">
                Our margins. Good enough to pay people well and stay sustainable.
              </p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-primary mb-2">2 Communities</p>
              <p className="text-sm text-muted-foreground">
                Washington and Ghana. Both matter to us.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663607234030/SUYffTLqfYfkiJeh93ob3u/grant-narrative-section-EaCjzA2tqFXYAtkCPVtmLd.webp')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            />
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground">
                    Families and Adult Family Homes pay us $30 per hour for care. DSHS covers it for people on Medicaid.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-2">
                    We Pay Caregivers $20/Hour
                  </p>
                  <p className="text-foreground">
                    That's a $10 margin per hour. After overhead, we're sustainable. Caregivers get paid well for their work.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-2">
                    Each Client Gets About 30 Hours a Month
                  </p>
                  <p className="text-foreground">
                    That's predictable, recurring revenue. As we add more clients, everything scales without needing to hire a huge team.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-2">
                  ...
                  <p className="text-foreground">
                    DSHS contracts, Adult Family Homes, private families. Diversified so we're not dependent on one source.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663607234030/SUYffTLqfYfkiJeh93ob3u/funding-opportunities-section-6kqRg6onXppQBPPVGKUBNz.webp')",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            />
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {caregiverBenefits.map((benefit, idx) => (
              <Card
                key={idx}
                className="p-8 bg-secondary/50 border-l-4 border-l-accent hover:shadow-lg transition-shadow"
              >
      ...
      <section id="for-families" className="py-16 md:py-24 bg-secondary/30">
        <div className="container">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary">
            For Families & Adult Family Homes
          </h2>
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {familyBenefits.map((benefit, idx) => (
              <Card
                key={idx}
                className="p-8 bg-white border-l-4 border-l-accent hover:shadow-lg transition-shadow"
              >
                <h3 className="text-lg font-bold text-primary mb-3">
                  {benefit.title}
                </h3>
          ...
          <div className="bg-primary text-primary-foreground p-8 rounded-lg text-center">
            ...
            <p className="mb-6 text-lg">
              Tell us what you need. We'll listen and find someone who's a good fit.
            </p>
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {goToMarketChannels.map((item, idx) => (
              <Card
                key={idx}
                className="p-8 bg-secondary/50 border-l-4 border-l-accent"
              >
                <h3 className="text-lg font-bold text-primary mb-3">
                  {item.channel}
                </h3>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground">
                    Not just credentials. We want people who show up, who care about their clients, who have emotional maturity. That matters more than anything.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-2">
                  ...
                  <p className="text-foreground">
                    Part of what we make goes back. Single moms in Washington get training and support. Kids in Ghana get opportunities. That's built into who we are.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-primary mb-2">
                    We're Actually Small
                  </p>
                  <p className="text-foreground">
                    We're not a huge corporation. You talk to us directly. We know your name. We solve problems fast. We care about what happens.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <Card className="p-6 bg-white">
                ...
                <p className="font-semibold text-primary">(253) 341-6755</p>
              </Card>
              <Card className="p-6 bg-white">
